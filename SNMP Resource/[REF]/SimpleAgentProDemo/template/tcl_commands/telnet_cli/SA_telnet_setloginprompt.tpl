...
<Template>
 <Version>1.0</Version>
 <Name>SA_telnet_setloginprompt</Name>
 <Contributor>SimpleSoft</Contributor>
 <Language>Tcl</Language>
 <Description>Sets the login prompt string used by the telnet server. By default it is set to the string &quot;login: &quot;
...
Note:
 ...
 <script>set string
SA_telnet_setloginprompt $string</script>
</Template>
