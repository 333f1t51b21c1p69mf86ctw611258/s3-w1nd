...
<Template>
 <Version>1.0</Version>
 <Name>SA_telnet_setaddloginmaxretrieserror</Name>
 <Contributor>SimpleSoft</Contributor>
 <Language>Tcl</Language>
 <Description>Sets the additional login error message string used by the telnet server when the max number of retries are exceeded in logging in. By default it is set to the string &quot;Too many failed logon attempts&lt;cr>&lt;lf>&quot;
...
Note:
 ...
 <script>set string
SA_telnet_setaddloginmaxretrieserror $string</script>
</Template>
