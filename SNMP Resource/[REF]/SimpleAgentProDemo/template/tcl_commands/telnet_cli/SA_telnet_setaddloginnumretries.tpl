...
<Template>
 <Version>1.0</Version>
 <Name>SA_telnet_setaddloginnumretries</Name>
 <Contributor>SimpleSoft</Contributor>
 <Language>Tcl</Language>
 <Description>Sets the additional login retry count.  If the invalid logins exceed this cound, based on the mode, the session is either terminated or the mode is set back to the basic mode.  By default its value is set to 3.
...
Note:
 ...
 <script>set count
SA_telnet_setaddloginnumretries $count</script>
</Template>
