...
<Template>
 <Version>1.0</Version>
 <Name>SA_telnet_setaddloginerror</Name>
 <Contributor>SimpleSoft</Contributor>
 <Language>Tcl</Language>
 <Description>Sets the additional login error message string displayed by the telnet server when the user incorrectly tries to login. By default it is set to the string &quot;Login incorrect&lt;cr>&lt;lf>&quot;
...
Note:
 ...
 <script>set string
SA_telnet_setaddloginerror $string</script>
</Template>
