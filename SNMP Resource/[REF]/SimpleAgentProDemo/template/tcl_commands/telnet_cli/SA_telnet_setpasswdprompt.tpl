...
<Template>
 <Version>1.0</Version>
 <Name>SA_telnet_setpasswdprompt</Name>
 <Contributor>SimpleSoft</Contributor>
 <Language>Tcl</Language>
 <Description>Sets the password prompt string used by the telnet server. By default it is set to the string &quot;Password: &quot;
...
Note:
 ...
 <script>set string
SA_telnet_setpasswdprompt $string</script>
</Template>
