...
<Template>
 <Version>1.0</Version>
 <Name>SA_sendtrap</Name>
 <Contributor>SimpleSoft</Contributor>
 <Language>Tcl</Language>
 <Description>Send the specified v1 trap to the associated trap manager IP address of the device. The enterpriseid in oid form, the values of the generic and specific fields along with an optional list of variable bindings.
...
set specific
set varbind
SA_sendtrap { $enterpid  $generic  $specific {$varbind}}</script>
</Template>
