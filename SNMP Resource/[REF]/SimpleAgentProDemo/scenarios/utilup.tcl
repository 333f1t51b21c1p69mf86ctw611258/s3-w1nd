...
set minoct [expr [expr $maxoct / 100 ] * $minUtil ]

# now set the ifInOctets valuetype
SA_setvaltype [list [list 1.3.6.1.2.1.2.2.1.10.$iPort OctetString "timedrandomup(1000, $maxoct, $minoct)" ] ] 

# now set the ifOutOctets valuetype
SA_setvaltype [list [list 1.3.6.1.2.1.2.2.1.16.$iPort OctetString "timedrandomup(1000, $maxoct, $minoct)" ] ] 
